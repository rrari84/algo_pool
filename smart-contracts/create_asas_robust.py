...
ADMIN_MN = "voice absorb rice inmate eternal coil inflict thumb rhythm base jar creek weird crime someone still shoe uncover organ harbor acoustic increase spoil absorb awkward"  # <-- paste your ADMIN mnemonic here
TRADER_MN = "observe orange empty modify blast ahead tag lottery switch current goddess identify abandon vote pipe logic power law stumble receive suit focus proud abstract solve" # <-- paste your TRADER mnemonic here
