...
# === Your mnemonics ===
ADMIN_MN = "voice absorb rice inmate eternal coil inflict thumb rhythm base jar creek weird crime someone still shoe uncover organ harbor acoustic increase spoil absorb awkward"
TRADER_MN = "observe orange empty modify blast ahead tag lottery switch current goddess identify abandon vote pipe logic power law stumble receive suit focus proud abstract solve"

# === Assets ===
ASSET_A_ID = 745475543
ASSET_B_ID = 745475544
REWARD_ASSET_ID = 745475554  # optional/unused by core AMM
